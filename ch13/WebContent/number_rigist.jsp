...
<table border="0">
	<tr>
		<td>
		<form action="insertlogin.jsp" name="user_info" 
			method="post" onsubmit="return checkFun()">
			<fieldset style="width:230px">
				<legend> 연락처 등록 </legend><p>
				...
				<td>메모  <input type="text" placeholder="메모" name="userMEMO" maxlength="100"></td>
				<tr height="30">
